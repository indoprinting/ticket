<div class="container-fluid" id="content">
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>
									...
									<span id="judul">Upload by IC</span>
								</h3>
							</div>

							<div class="box-content">
								<form action="<?php echo base_url(); ?>payroll/addic" method="POST" class='form-validate'  id="bb" autocomplete="off" enctype="multipart/form-data">
									...
									<div class="form-actions">
										...
										<a href="<?php echo base_url().'payroll/downloadic' ?>">Download format Form Upload</a> 
	...
	<script type="text/javascript">
		function cancel_btn() {
			$("#bb").attr('action', '<?php echo base_url(); ?>payroll/ic');
		    $("#judul").html("Upload by IC");
