					...
					<div class="col-sm-12">
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<form action="<?php echo base_url(); ?>ticket/store" method="POST" class='form-horizontal form-column form-bordered form-validate'  id="bb" autocomplete="off" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-6">
									...
									<!-- <div class="row"> -->
										<div class="col-sm-12" style="border-top: 1px solid #ddd;">
											...
											<div class="form-actions">
												...
												<a href="<?php echo base_url().'ticket/'.$_GET['b']; ?>"><button type="button" class="btn">Cancel</button></a>
											</div>
										</div>
									<!-- </div> -->
								</form>
	...
	<script type="text/javascript">
		...
		$('#subject').change(function(){
		    ...
		    $.ajax({
				method: "POST",
				url: "<?php echo base_url(); ?>ticket/subjPart/"+part,
