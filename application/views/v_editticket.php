				...
				<div class="row">
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								...
								<div class="pull-right" style="margin-right: 5px;">
									<a href="<?php echo base_url().'ticket/'.$b; ?>"><button type="button" class="btn">Back</button></a>
								</div>
							</div>
					...
					<div class="col-sm-4">
						<div class="box box-color box-bordered lime">
							...
							<div class="box-content nopadding edit_form">
								<form action="<?php echo base_url(); ?>ticket/update/<?php echo $ticket->id.'?b='.$b; ?>" method="POST" class='form-horizontal form-column form-bordered form-validate' autocomplete="off" id="detail_form" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-12">
											<?php
