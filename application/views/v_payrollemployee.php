								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<button data-id="<?php echo $row->id; ?>" data-pin="<?php echo $row->pin; ?>" data-nama="<?php echo $row->nama; ?>" data-job_title="<?php echo $row->job_title; ?>" data-div_name="<?php echo $row->div_name; ?>" data-company="<?php echo $row->company; ?>" data-basic="<?php echo $row->basic; ?>" data-allowance="<?php echo $row->allowance; ?>" data-bpjs="<?php echo $row->bpjs; ?>" data-pulsa="<?php echo $row->pulsa; ?>" data-hire_date="<?php echo $row->hire_date; ?>" data-norek="<?php echo $row->norek; ?>" data-whatsapp="<?php echo $row->whatsapp; ?>" data-birth_date="<?php echo $row->birth_date; ?>" data-gender="<?php echo $row->gender; ?>" data-marriage="<?php echo $row->marriage; ?>" data-ktp="<?php echo $row->ktp; ?>" data-addr="<?php echo $row->addr; ?>" data-daywork="<?php echo $row->daywork; ?>" data-penalty="<?php echo $row->penalty; ?>" class="btn edit-btn" rel="tooltip" title="Edit Employee">
						...
						<div class="box-content">
							<form action="<?php echo base_url(); ?>payroll/addemployee" method="POST" class='form-horizontal form-validate' id="bb">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="password" id="password" style="width:80%;" placeholder="Enter new password to change" data-rule-required="false">
									</div>
								</div>
