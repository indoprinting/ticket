<div class="container-fluid" id="content">
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>
									...
									<span id="judul">Upload by MGR</span>
								</h3>
							</div>

							<div class="box-content">
								<form action="<?php echo base_url(); ?>payroll/addmgr" method="POST" class='form-validate'  id="bb" autocomplete="off" enctype="multipart/form-data">
									...
									<div class="form-actions">
										...
										<a href="<?php echo base_url().'payroll/downloadmgr' ?>">Download format Form Upload</a> 
								...
								<table class="table table-hover table-nomargin table-bordered dataTable">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<?php echo number_format($row->desain,0,",","."); ?>
	...
	<script type="text/javascript">
		function cancel_btn() {
			$("#bb").attr('action', '<?php echo base_url(); ?>payroll/mgr');
		    $("#judul").html("Upload by MGR");
