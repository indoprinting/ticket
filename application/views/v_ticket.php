<?php 
    ...
    if ($path!='assignticket' && $path!='departmentticket' && $path!='locationticket' && $path!='historyticket'){
    	$back = 'index';
    } else {
    	$back = $path;
    }
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								...
								<div class="pull-right">
									<a href="<?php echo base_url(); ?>ticket/create/<?php echo '?b='.$back; ?>" class="create_btn">Create Ticket</a>
								</div>
							</div>
								...
								<table width="2050px" id="example" class="table table-hover table-nomargin dataTable-column_filter table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url().'ticket/edit/'.$row->id.'?b='.$back; ?>"><?php echo $row->subject; ?></a>
											</td>
											<td>
